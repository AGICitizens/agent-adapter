...
- Always refer the docs/ directory for docs regarding the project, decisions etc. If needed, update those documents.
- Keep the code digestable, in their dedicated modules and lean.
